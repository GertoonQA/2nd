...
# options.add_argument("--window-size=1920,1080")  # Хэрэв хэрэгтэй бол
options.add_argument("--disable-gpu")  # GPU-г идэвхгүй болгох
...
doc.add_paragraph("1. Browser нээгдэж, login хуудас ачааллаа.")
...
doc.add_paragraph("4. 'Secure Area' гарчиг амжилттай илэрлээ.")
